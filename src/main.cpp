...
unsigned int nStakeMinAge = 60 * 60 * 24 * 30;	// minimum age for coin age: 5d
unsigned int nStakeMaxAge = 60 * 60 * 24 * 60;	// stake age of full weight: 15d
unsigned int nStakeTargetSpacing = 60;			// 1-minute block spacing

int64 nChainStartTime = 1376239000;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "He's dead Dave, everybody's dead, everybody is dead Dave...";
        CTransaction txNew;
		...
		txNew.strTxComment = "text:DollarPounds genesis block";
        ...
        block.nVersion = 1;
        block.nTime    = 1376239000;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 65286665;
        ...
        assert(block.hashMerkleRoot == uint256("0x5ebfb8bebc92195dbfba947f3ee40aa3472a82ff8aeca46cf7c69c362dadbc9d"));
